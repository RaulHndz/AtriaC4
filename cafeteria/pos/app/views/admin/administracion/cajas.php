<div class="title">Administraci&oacute;n de Cajas
...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-condensed table-hover">
        ...
        <?php foreach ($cajas as $caja): ?>
            <tr>
                <td>
                    <a href="#" onclick="_view('<?php echo $caja->codigo; ?>')"><?php echo $caja->codigo; ?></a>
                </td>
                <td><?php echo $caja->nombre; ?></td>
                <td><?php echo $caja->estado; ?></td>
                <td align="center"><a href="#" onclick="_directEdit('<?php echo $caja->codigo; ?>')" class="link-edit" title="Editar"></a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
...
<script>
    ...
    {
        var _url = base_url + 'ajax/get_caja';
    ...
    function _add()
    {
        ...
        var _action = base_url + 'procesator/savecaja';
        $('#procesor').attr('action', _action);
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-condenced table-bordered">
                        ...
                        <tr><th>Sucursal</th><td><span id="vw_tienda"></span></td></tr>
...
<div id="save_product" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="procesor" action="<?php echo base_url(); ?>procesator/savecaja" method="post">
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-condenced table-bordered">
                            ...
                            <tr>
                                <th>Tienda</th>
                                <td>
                                    <select name="tienda" id="sv_cate" class="form-control">
