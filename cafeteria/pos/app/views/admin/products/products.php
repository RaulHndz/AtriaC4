            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-condenced table-bordered">
                        ...
                        <tr><th>Peso</th><td><span id="vw_peso"></span></td></tr>
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-condenced table-bordered">
                            ...
                            <tr><th>Peso</th><td><input name="peso" id="sv_peso" type="text" class="form-control"></td></tr>
