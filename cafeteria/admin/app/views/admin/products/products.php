...
<script>
    ...
    function Search(){
        ...
        var _url = "<?php echo base_url().'admin/buscarproductos/'; ?>";
        $.ajax({
                url: _url,
                type: 'post',
                dataType: 'json',
        ...
        }).done(function(data)
        {
            ...
            $(data).each(function(){
                $('#wrapper_recibos').append(   '<tr>'+
                                                '    <td>'+
                                                '        <a href="#" onclick="viewProduct(\''+this.codigo+'\')">'+this.codigo+'</a>'+
                                                '    </td>'+
                                                '    <td>'+this.nombre+'</td>'+
                                                '    <td>'+this.estado+'</td>'+
                                                '    <td>$'+this.costo+'</td>'+
    ...
    function viewProduct(_codigo)
    {
        ...
        $.ajax({url: _url, data : {codigo: _codigo}, type: 'post', dataType: 'json'}).done(function(data){
            ...
            $('#vw_precio1').text(data.precio1);
            $('#vw_precio2').text(data.precio2);
    ...
    function _edit()
    {
        ...
        $.ajax({url: _url, data : {codigo: _product_code}, type: 'post', dataType: 'json'}).done(function(data){
            ...
            $('#sv_precio1').val(data.precio1);
            $('#sv_precio2').val(data.precio2);
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-condenced table-bordered">
                        ...
                        <tr><th>Precio 1</th><td><span id="vw_precio1"></span></td></tr>
                        <tr><th>Precio 2</th><td><span id="vw_precio2"></span></td></tr>
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-condenced table-bordered">
                            ...
                            <tr><th>Precio 1</th><td><input name="precio1" id="sv_precio1" type="text" class="form-control"></td></tr>
                            <tr><th>Precio 2</th><td><input name="precio2" id="sv_precio2" type="text" class="form-control"></td></tr>
                            <tr>
                                <th>Categoria</th>
                                <td>
