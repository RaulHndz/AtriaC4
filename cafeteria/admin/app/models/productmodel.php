...
class ProductModel extends CI_Model {
	...
	public function getProductos($product)
	{

		$codigo = '%'.$product.'%';
		$nombre = '%'.$product.'%';

		$sql = "SELECT a.*, c.nombre categoria FROM articulo a inner join categoria c on a.categoria_codigo = c.codigo where a.codigo like ? or a.nombre like ? LIMIT 0, 30";
