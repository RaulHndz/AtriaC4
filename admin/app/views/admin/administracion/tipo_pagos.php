<div class="title">Administraci&oacute;n de Formas de Pago
...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-condensed table-hover">
        ...
        <?php foreach ($tipopagos as $tipopago): ?>
            <tr>
                <td>
                    <a href="#" onclick="_view('<?php echo $tipopago->codigo; ?>')"><?php echo $tipopago->codigo; ?></a>
                </td>
                <td><?php echo $tipopago->nombre; ?></td>
                <td><?php echo $tipopago->estado; ?></td>
                <td align="center"><a href="#" onclick="_directEdit('<?php echo $tipopago->codigo; ?>')" class="link-edit" title="Editar"></a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
...
<script>
    ...
    {
        var _url = base_url + 'ajax/get_tipopago';
    ...
    function _edit()
    {
        var _url = base_url + 'ajax/edit_tipopago';
        $.ajax({url: _url, data : {codigo: _product_code}, type: 'post', dataType: 'json'}).done(function(data){

            _product_code = data.codigo;

            var _action = base_url + 'procesator/updatetipopago';
    ...
    function _add()
    {
        ...
        var _action = base_url + 'procesator/savetipopago';
        $('#procesor').attr('action', _action);
...
<div id="save_product" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="procesor" action="<?php echo base_url(); ?>procesator/savetipopago" method="post">
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-condenced table-bordered">
